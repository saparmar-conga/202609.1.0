...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">Conga Digital Commerce 202609.1.0 on Conga Revenue Lifecycle Platform</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            ...
                            <li class="link">
                                <a href="components/TaxBreakupComponent.html" data-type="entity-link" >TaxBreakupComponent</a>
                            </li>
                            <li class="link">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="classes-links"' : 'id="xs-classes-links"' }>
                            ...
                            <li class="link">
                                <a href="classes/DetailActionSet.html" data-type="entity-link" >DetailActionSet</a>
                            </li>
                            <li class="link">
                        ...
                        <li class="chapter">
                            ...
                            <ul class="links collapse " ${ isNormalMode ? 'id="injectables-links"' : 'id="xs-injectables-links"' }>
                                <li class="link">
                                    <a href="injectables/AccountLocationManagementService.html" data-type="entity-link" >AccountLocationManagementService</a>
                                </li>
                                <li class="link">
                                ...
                                <li class="link">
                                    <a href="injectables/ApiEndpointService.html" data-type="entity-link" class="deprecated-name">ApiEndpointService</a>
                                </li>
                                <li class="link">
                                ...
                                <li class="link">
                                    <a href="injectables/DisplayColumnService.html" data-type="entity-link" >DisplayColumnService</a>
                                </li>
                                <li class="link">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? ' id="interfaces-links"' : 'id="xs-interfaces-links"' }>
                            ...
                            <li class="link">
                                <a href="interfaces/CartAction.html" data-type="entity-link" >CartAction</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="interfaces/DataQueryOptions.html" data-type="entity-link" >DataQueryOptions</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/DataQuerySort.html" data-type="entity-link" >DataQuerySort</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/DetailAction.html" data-type="entity-link" >DetailAction</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/DetailActionContext.html" data-type="entity-link" >DetailActionContext</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/DisplayColumn.html" data-type="entity-link" >DisplayColumn</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="interfaces/PriceColumn.html" data-type="entity-link" >PriceColumn</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="interfaces/UserContactMapping.html" data-type="entity-link" >UserContactMapping</a>
                            </li>
                            <li class="link">
